...
SRC_URI="https://api.github.com/repos/openssh/openssh-portable/tarball/refs/tags/V_10_2_P1 -> openssh-10.2_p1-d01efaa.tar.gz"
...
post_src_unpack() {
	mv openssh-openssh-portable-* "${S}" || die
}
